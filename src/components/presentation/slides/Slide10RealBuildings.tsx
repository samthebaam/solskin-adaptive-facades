...
import swissAlps from "@/assets/slides/swiss-alps.jpg";
  ...
  <SlideLayout>
    ...
    <div className="flex gap-8 animate-fade-in-up delay-200">
      {[
        ...
        { img: swissAlps, title: "Greber — Swiss Alps", desc: "Residential installation adapting to alpine climate", tag: "Residential" },
        { img: kellerRender, title: "KELLER Diamant — Winterthur", desc: "Our largest installation to date — 1,300 m²", tag: "Flagship" },
        ...
        <div key={i} className={`flex-1 group animate-fade-in-up delay-${(i + 3) * 100}`}>
          ...
          <h3 className="text-2xl font-semibold mb-2 leading-normal">{title}</h3>
