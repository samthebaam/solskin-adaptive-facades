    ...
    <div className="flex gap-16">
      <div className="flex-1 space-y-8 animate-fade-in-up delay-200">
        <p className="text-2xl text-slide-gray-100 leading-relaxed">
          Research started in <span className="text-slide-gold font-semibold">2013</span>. If a facade should adapt to the environment, it needs to <span className="font-semibold">move</span>.
        </p>

        <p className="text-xl text-slide-gray-200 leading-relaxed">
        ...
        <div className="flex gap-6 mt-6">
          {[
            ...
            <div key={i} className="flex-1 p-5 bg-slide-gray-600 rounded-xl text-center">
              ...
              <p className="text-sm text-slide-gray-200 mt-1">{label}</p>
            </div>
          ))}
        </div>
      </div>
