      ...
      <div className="flex-1 space-y-10">
        {[
          ...
          <div key={i} className={`flex items-start gap-6 animate-fade-in-up delay-${(i + 3) * 100}`}>
            <div className="w-20 h-20 rounded-xl bg-slide-gray-600 flex items-center justify-center shrink-0">
              <Icon size={40} className="text-slide-gold" />
            </div>
            <div>
              <h3 className="text-2xl font-semibold mb-2 leading-normal">{label}</h3>
        ...
        <div className="mt-8 p-6 border border-slide-gold/30 rounded-xl bg-slide-gold/5 animate-fade-in-up delay-700">
          <p className="text-2xl text-slide-gold font-display italic leading-relaxed">
